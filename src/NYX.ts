...
class NYXCommands {
   ...
   private async init(options: Options) {
      ...
      this._cooldowns = new Cooldowns(this as unknown as NYX, {
      ...
      if (featuresDir)
         new FeaturesHandler(this as unknown as NYX, featuresDir, client)
